...
func _get_options() -> Dictionary[int, MenuOption]:
	return {
		...
		Viewport.SCALING_3D_MODE_FSR: MenuOption.new(1, Viewport.SCALING_3D_MODE_FSR, "FSR1"),
		Viewport.SCALING_3D_MODE_FSR2: MenuOption.new(2, Viewport.SCALING_3D_MODE_FSR2, "FSR2")
	}
